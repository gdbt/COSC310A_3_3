...
static int shmeegultest;
	public String main(String input)  {
		...
		//checking least favorite character
			...
			shmeegultest = (int)(Math.random()*2);
			if(shmeegultest == 0)
				return("Definately wormtongue. Hes the worst roar!");
			else
		...
		//checking favorite COUNTRY
			...
			return("Definately Mordor! Sauron lives their!");
		}
		//favorite character
		...
		//saying wormtongue
			...
			if(shmeegultest == 0) {
				...
				return("Dont like that one. hes a bad egg");
			}
		}
